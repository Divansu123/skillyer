...
const QUALIFICATIONS = [
  '10th Pass', '12th Pass', 'Diploma', 'B.Tech/B.E.', 'B.Sc', 'B.Com',
  'B.A', 'BCA', 'MCA', 'M.Tech/M.E.', 'MBA', 'M.Sc', 'Ph.D', 'Other',
];
        ...
        {success ? (
          <div style={{ textAlign: 'center', padding: '28px 0' }}>
            ...
            <p style={{ color: 'var(--text2)', fontSize: 14, lineHeight: 1.6, marginBottom: 24 }}>
              We will contact you at <strong>{form.email}</strong> with course access details.
            </p>
          ...
          <div>
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ color: 'var(--text3)', fontSize: 12 }}>
                  ...
                  {course.price === 0 ? ' · Free' : course.price ? ' · Rs.' + course.price : ''}
                </div>
              </div>
            </div>
            ...
            {error && (
              <div style={{
                color: 'var(--accent2)', fontSize: 13, marginBottom: 14,
